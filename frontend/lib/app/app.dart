...
import '../core/live_heatmap_screen.dart';
import '../core/live_skeleton_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AppRoutes.skeleton: (_) => const LiveSkeletonScreen(),
        AppRoutes.heatMap: (_) => const LiveHeatMapScreen(),
        AppRoutes.compare: (_) => const CompareScreen(),
        AppRoutes.gamification: (_) => const GamificationScreen(),
        AppRoutes.history: (_) => const SessionHistoryScreen(),
      },
    );
  }
}
